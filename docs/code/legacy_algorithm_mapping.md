...
| `Raspberry Pi Zero 2` | `Raspberry Pi Zero` | Naujoje versijoje Pi naudoja kamerą `OV5647` vaizdui ir priekyje esančio atstumo įvertinimui. |
...
Šią pačią struktūrą galima perkelti į naują robotą, tik pritaikant ją prie `ESP32` skaičiavimų, kameros duomenų iš `Raspberry Pi Zero` ir mažesnio ToF kiekio.

## Kaip Tai Atrodo Naujame Robote

- `Raspberry Pi Zero` fiksuoja `OV5647` kamerą ir perduoda kameros duomenis.
