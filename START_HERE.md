...
If you want the full story of the robot, this order works well:
...
The repository still contains some more detailed or older support files. The files listed above are the ones we would point a judge to first.
